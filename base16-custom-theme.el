...
(let ((background "#202020")
  ...
  (custom-theme-set-faces
   ...
   `(rainbow-delimiters-depth-2-face ((t (:foreground ,aqua))))
   `(rainbow-delimiters-depth-3-face ((t (:foreground ,yellow))))
   `(rainbow-delimiters-depth-4-face ((t (:foreground ,green))))
   `(rainbow-delimiters-depth-5-face ((t (:foreground ,blue))))
   `(rainbow-delimiters-depth-6-face ((t (:foreground ,foreground))))
   `(rainbow-delimiters-depth-7-face ((t (:foreground ,aqua))))
   ...
   `(isearch-lazy-highlight-face ((t (:foreground ,aqua :background ,background :inverse-video t))))
   ...
   ;`(text-cursor ((t (:background ,red))))
   `(fringe ((t (:background ,current-line))))
   `(linum ((t (:background ,current-line))))
   `(border ((t (:background ,current-line))))
   `(border-glyph ((t (nil))))
   `(highlight ((t (:inverse-video nil :background ,current-line))))
   `(gui-element ((t (:background ,current-line :foreground ,foreground))))
   `(mode-line ((t (:foreground nil :background ,current-line       :box nil))))
   `(mode-line-buffer-id ((t (:foreground ,purple :background nil))))
   `(mode-line-inactive ((t (:inherit mode-line :foreground ,comment :background ,current-line :weight normal :box nil))))
  ...
  `(whitespace-indentation ((t (:background nil :foreground ,aqua))))
  ...
  `(show-paren-mismatch ((t (:background ,purple :foreground ,background))))
  ...
  `(erb-comment-face ((t (:background ,current-line :weight bold :slant italic))))
  ...
  `(message-header-newsgroups ((t (:foreground ,aqua :background nil :slant normal))))
  ...
  `(jabber-activity-personal-face ((t (:foreground ,aqua))))
  ...
  `(gnus-summary-normal-ancient ((t (:foreground ,aqua :weight normal))))
  ...
  `(gnus-group-mail-1-empty ((t (:inherit gnus-group-mail-1 :foreground ,comment))))
  `(gnus-group-mail-2-empty ((t (:inherit gnus-group-mail-2 :foreground ,comment))))
  `(gnus-group-mail-3-empty ((t (:inherit gnus-group-mail-3 :foreground ,comment))))
  `(gnus-group-mail-4-empty ((t (:inherit gnus-group-mail-4 :foreground ,comment))))
  `(gnus-group-mail-5-empty ((t (:inherit gnus-group-mail-5 :foreground ,comment))))
  `(gnus-group-mail-6-empty ((t (:inherit gnus-group-mail-6 :foreground ,comment))))
  ...
  `(erc-timestamp-face ((t (:foreground ,aqua))))
